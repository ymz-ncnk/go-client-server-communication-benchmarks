...
func (c *echoServiceClient) Echo(ctx context.Context, in *protobuf.Data, opts ...grpc.CallOption) (*protobuf.Data, error) {
	out := new(protobuf.Data)
...
func (UnimplementedEchoServiceServer) Echo(context.Context, *protobuf.Data) (*protobuf.Data, error) {
...
func _EchoService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServiceServer).Echo(ctx, req.(*protobuf.Data))
	}
